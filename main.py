...
maze = Maze(agents=agents, max_timestep=1500, rand_sizes=True, rand_range=[3,3], rand_start=True, difficulty=1, default_size=[4,4]) 
# brain.train()
maze.display_policy() #specify the tag of the agent you want to see. If none is specified you will see the whole maze 
# 