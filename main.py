...
brain = PPO(agent_amount=2, batch_size=15000, lr=0.00023)
agents = (Agent('RED', brain, RED, PALE_RED, 2),
        Agent('BLUE',brain, BLUE, PALE_BLUE, 3))
maze = Maze(agents=agents, max_timestep=1500, rand_sizes=True, rand_range=[6,8], rand_start=True, difficulty=1, default_size=[4,4]) 
brain.train()
# maze.display_policy()